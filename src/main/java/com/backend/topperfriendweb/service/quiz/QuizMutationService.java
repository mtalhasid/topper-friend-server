...
@Service
public class QuizMutationService {
    private final QuizRepository quizRepository;
    private final GeminiService geminiService;
    private final ObjectMapper objectMapper;

    public QuizMutationService(QuizRepository quizRepository,
    ...
    public QuizSubmissionResponse submitQuiz(SubmitQuizRequest request, User user) {
        try {
            ...
            return new QuizSubmissionResponse(true, score, totalQuestions, weaknessSummary,
