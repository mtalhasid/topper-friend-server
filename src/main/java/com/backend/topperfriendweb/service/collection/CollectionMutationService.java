...
public class CollectionMutationService {
    ...
    public CollectionDTO createCollection(CreateCollectionRequest request, User user) {
        try {
            ...
            dto.setTitle(savedCollection.getTitle());
            dto.setDescription(savedCollection.getDescription());
            dto.setUserId(savedCollection.getUserId());
            dto.setCreatedAt(savedCollection.getCreatedAt());
            dto.setUpdatedAt(savedCollection.getUpdatedAt());
            return dto;
        } catch (Exception e) {
    ...
    public CollectionDTO updateCollection(Long collectionId, UpdateCollectionRequest request, User user) {
        try {
            ...
            CollectionDTO dto = new CollectionDTO();
            dto.setId(updatedCollection.getId());
            dto.setTitle(updatedCollection.getTitle());
            dto.setDescription(updatedCollection.getDescription());
            dto.setUserId(updatedCollection.getUserId());
            dto.setCreatedAt(updatedCollection.getCreatedAt());
            dto.setUpdatedAt(updatedCollection.getUpdatedAt());
            return dto;
